...
class Helpers
{
    #[NoReturn] public static function dd(mixed $data = ["This is not empty"], bool $pretty=true):void {
        if($data !== ["This is not empty"]) {
            self::dump(data: $data, pretty: $pretty);
        }
        exit(0);
    }
    ...
    /**
     * Just blatantly stolen from https://stackoverflow.com/a/31771930
     * @param $data
     * @param string $label
     * @param false $return
     * @return string|void
     */
    public static function var_dump_pretty($data, $label='', $return = false) {
